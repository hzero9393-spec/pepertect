      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="max-w-4xl font-heading text-5xl font-bold tracking-tight text-text-primary sm:text-6xl lg:text-7xl">
              Master Trading
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <a href="/register">
                <Button size="lg" className="w-full bg-brand-primary hover:bg-brand-primary-hover px-8 text-white font-semibold">
                  Start Trading Free
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </a>
              <a href="/login">
                <Button variant="outline" size="lg" className="w-full border-border-default px-8">
                  Sign In
                </Button>
              </a>
            </div>
      ...
      <section className="border-t border-border-default bg-bg-surface">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="font-heading text-3xl font-bold text-text-primary">Simple Pricing</h2>
            <p className="mt-2 text-text-secondary">Start free, upgrade when ready</p>
            <div className="mt-10 grid gap-6 max-w-lg mx-auto md:grid-cols-2">
              <div className="rounded-lg border border-border-default bg-bg-base p-6">
                <p className="text-sm font-medium text-text-secondary">Free</p>
                <p className="mt-2 font-heading text-4xl font-bold text-text-primary">₹0</p>
              ...
              <div className="rounded-lg border-2 border-brand-primary bg-bg-base p-6">
                ...
                <p className="mt-2 font-heading text-4xl font-bold text-text-primary">₹299</p>
