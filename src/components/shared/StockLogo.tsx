...
const STOCK_DOMAINS: Record<string, string> = {
  ...
  // ---------------- Extended universe (NSE/BSE stocks) ----------------
  // Banking & Finance
  YESBANK: 'yesbank.in',
  IDFCFIRSTB: 'idfcfirstbank.com',
  UCOBANK: 'ucobank.co.in',
  ...
  LICHF: 'lichousing.com',
  CENTRUM: 'centrum.co.in',
  EDL: 'edelweissfin.com',
  SURYODAY: 'suryodaysfb.com',
  UJJIVAN: 'ujjivansfb.in',
  EQUITAS: 'equitasbank.com',
  CREDITACC: 'creditaccessgrameen.com',
  SPANDANA: 'spandanasphoorty.com',
  MASFIN: 'masfin.in',
  ARMANFIN: 'armanindia.in',
  FIVESTAR: 'fivestarbusinessfinance.com',

  // Energy, Power & Oil
  ADANIPOWER: 'adani.com',
  JSWENERGY: 'jswenergy.in',
  ...
  DEVYANI: 'devyani-international.com',
  SAPPHIRE: 'sapphirefoods.in',
  BARBEQUE: 'barbeque-nation.com',
  AWL: 'adaniwilmar.in',
  EMAMILTD: 'emami.in',
  TATACOFFEE: 'taticoffee.com',

  // Metals & Mining
  JSL: 'jindalstainless.com',
  HEG: 'hegltd.com',
  CARBORUNDUM: 'carborundumuniversal.com',
  ...
  CAMSSERVICES: 'camsonline.com',
  MAPMYINDIA: 'mapmyindia.com',
  RATESENS: 'rategain.com',
  TBOTEK: 'tbo.com',
  KAYNES: 'kaynestech.com',
  DIXONTECH: 'dixoninfo.com',
  AVALON: 'avalontech.in',
  SYRMASGS: 'syrmasgs.com',
  HAPPYFORGE: 'happyforgings.com',
  ...
  UPL: 'upl-ltd.com',
  COROMANDEL: 'coromandel.co.in',
  VINATIORGA: 'vinatiorganics.com',
  AARTIIND: 'aarti-industries.com',
  AARTIPHARM: 'aartipharmalab.com',
  ATUL: 'atul.co.in',
  AKZOINDIA: 'akzonobel.com',
  ROSSARI: 'rossari.com',
  SUMITOMO: 'sumitomochemical.com',
  ...
  SIEMENS: 'siemens.com',
  ABBPOWER: 'abb.com',
  INFRATEL: 'bharti-infratel.in',

  // Cement & Construction
  RAMCOCEM: 'ramcoindia.com',
  DALBHARAT: 'dalmiabharat.com',
  KESORAM: 'kesoram.com',
  MANGALAM: 'mangalamcement.com',
  BIRLACORP: 'birlacorporation.com',
  INDIAWODE: 'indiawode.com',
  ...
  EMBASSY: 'embassytakes.com',
  PHOENIXLTD: 'phoenixmarketcity.com',
  SUNTECK: 'sunteckgroup.com',
  MAHLIFE: 'mahindralifespaces.com',
  AMBUJAENTE: 'ambuja.co.in',

  // Telecom & Media
  INDHOTEL: 'ihcltata.com',

  // Retail & Consumer
  TITANJEWEL: 'titancompany.in',
  KALYANKJIL: 'kalyanjewellers.net',
  RELAXO: 'relaxoindia.com',

  // Infrastructure & Logistics
  BLUEDART: 'bluedart.com',
  TCI: 'tcil.com',
  ALLCARGO: 'allcargo.com',
  MAHLOG: 'mahindralogistics.com',
  CONTAINER: 'concorindia.com',
  DELHIVERY: 'delhivery.com',
  GESHIP: 'geship.com',
  SCI: 'shipindia.com',
  IRB: 'irb.co.in',
  'IL&FSTRANS': 'ilfs.in',
  ASHOKABLD: 'ashoka.com',
  ASHOKA: 'ashoka.com',
  KNRCORP: 'knrcorp.com',
  NCC: 'nccindia.com',
  ...
  SKFINDIA: 'skf.com',
  CARBORUNDUMUNIV: 'carborundumuniversal.com',
  POLYCAB: 'polycab.com',
  FINOLEX: 'finolex.com',
  FINCABLES: 'finolex.com',
  KEIIND: 'kei-ind.com',
  VGUARD: 'vguard.in',
  BAJELECT: 'bajajelectricals.com',
  ORIENTELEC: 'orient-electric.com',
  ORIENTBELL: 'orientbell.com',
  CROMPTON: 'crompton.co.in',
  CROMPTONGREV: 'crompton.co.in',
  SYMPHONY: 'symphonyltd.com',
  WHIRLPOOL: 'whirlpoolindia.com',
  TTKPRESTIGE: 'ttk-prestige.com',
  MILLENNIUM: 'millenniumindia.com',
  ...
  // Agri & Sugar
  BALRAMCHIN: 'balrampurchin.com',
  AVADH: 'avadhsugar.com',
  DWARKESH: 'dwarkesh.com',
  MAGADSUGAR: 'magadhsugar.com',
  EIDPARRY: 'eIDparry.com',
  BAJAJHIND: 'bajajhindusthan.com',
  TRIVENI: 'triveni.com',
  DHAMPUR: 'dhampursugar.com',

  // Dairy
  HERITGFOOD: 'heritagefoods.in',
  PRABHAT: 'prabhatdairy.com',
  HATSUN: 'hatsun.com',

  // ETFs
  NIFTYBEES: 'nipponindiaimf.com',
  BANKBEES: 'nipponindiaimf.com',
  GOLDBEES: 'nipponindiaimf.com',
  ITBEES: 'nipponindiaimf.com',
  PHARMABEES: 'nipponindiaimf.com',
  LIQUIDBEES: 'nipponindiaimf.com',
  HDFCSML250: 'hdfcfund.com',
  MID150BEES: 'nipponindiaimf.com',

  // Jewellery
  TITANCO: 'titancompany.in',
  TRIBHOV: 'tbztheoriginal.com',

  // Conglomerate
  TATAINVEST: 'tata.com',
  TTKHLTH: 'ttkhealthcare.com',
  BAJAJHLDNG: 'bajajfinserv.in',
  BAJAJELECT: 'bajajelectricals.com',
  ZUARI: 'zuari.com',
  'DCM Shriram': 'dcmsriram.com',
  DCMSHRIRAM: 'dcmsriram.com',
};
