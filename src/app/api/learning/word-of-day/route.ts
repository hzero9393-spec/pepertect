...
const WORD_POOL = [
  ...
  { word: 'Margin', meaning: 'Broker se li hui temporary credit for trading. Futures/options mein compulsory.', example: 'Nifty futures lot size 65, margin ~₹15,000. Ye blocked amount hai.', category: 'Trading' },
  { word: 'Lot Size', meaning: 'Minimum tradeable quantity in derivatives. Nifty=65, BankNifty=30, FinNifty=60.', example: '1 Nifty option = 65 units. Premium ₹100 → total ₹6,500 value.', category: 'Derivatives' },
